 ...
 *  @since v7.0.0
 */
- (void)setBirthdate:(NSDate *_Nullable)date;
 ...
 *  @since v7.0.0
*/
- (void)setLocation:(CLLocation *_Nullable)geoLocation;
 ...
 *  @since v7.0.0
 */
- (void)setZipcode:(NSString *_Nullable)zipcode;
 ...
 *  @since v7.0.0
 */
- (void)setInterests:(NSArray *_Nullable)interests;
 ...
 *
 * @param privacyString IAB US privacy string under CCPA.
 */
- (void)setIABUSPrivacyString:(nullable NSString *)privacyString;
 ...
 *  @since v7.0.0
 */
- (void)dataWithCurrentLocation:(void (^_Nullable)(NSDictionary *  data))completionBlock;
