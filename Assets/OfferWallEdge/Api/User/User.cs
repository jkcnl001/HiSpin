...
namespace FyberPlugin
{
  ...
  public partial class User
  {
    ...
    // MARK: - IAB US Privacy String

    static public void SetIABUSPrivacyString(string iabUsPrivacyString) {
      Put(IAB_US_PRIVACY_STRING, iabUsPrivacyString);
    }

    static public void ClearIABUSPrivacyString() {
      Put(IAB_US_PRIVACY_STRING, null);
    }
    ...
    protected const string IAB_US_PRIVACY_STRING = "iab_us_privacy_string";
